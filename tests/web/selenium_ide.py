...
class TestComprarPassagem:
    ...
    def test_comprar_passagem(self):
        ...
        self.driver.find_element(By.ID, "inputName").send_keys("jão")
    ...
    def test_testeLogin(self):
        ...
        self.driver.find_element(By.ID, "email").send_keys("jorgesmk@hotmail.com")
        self.driver.find_element(By.CSS_SELECTOR, ".btn-primary").click()
        self.driver.find_element(By.CSS_SELECTOR, ".btn-primary").click()
        self.driver.find_element(By.CSS_SELECTOR, ".btn-primary").click()
    ...
    def test_login_positivo(self):
        ...
        self.driver.find_element(By.ID, "email").send_keys("ead@iteras144447ys.com.br")
